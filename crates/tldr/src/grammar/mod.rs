...
use datafusion::physical_expr::udf::ScalarUDF;
use datafusion::logical_expr::{FuncMonotonicity, ScalarUDFImpl, Signature};
            ...
            (
                ...
                let result_array = match exp {
                    ...
                    Some(exp) => {
                        ...
                        let res: Float64Array = compute::unary(base_array, |base| base.powf(*exp));
                        Arc::new(res)
                    }
                };
            ...
            (
                ...
                let res = match base {
                    ...
                    Some(base) => {
                        ...
                        let res: Float64Array = compute::unary(exp_array, |exp| base.powf(exp));
                        Arc::new(res)
                    }
                };
